...
本文是 2026-09-18 针对 Eddie 阅读反馈的历史排查记录，当时版本为 `experience_recap_v1_1`、`experience_view_v1_2`。该次修复没有改变事件筛选与归并条件，也没有修改游戏采集代码。下文短引用和样例仅属于当时快照；最新版本和验收状态见[验证摘要](validation.md)。

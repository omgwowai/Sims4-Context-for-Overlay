...
状态：2026-09-18，短版已迭代至 `experience_recap_v1_1`，用户认可当前 Eddie 阅读版。当前默认 JSON 为 8,992–9,807 token；第 1–7 节保留最初方案及基线，第 8 节保留分层接口设计依据。四层接口已进入 MOD 0.10.0 / API、SDK 2.2.0 源码，当前可调用契约及限制以[分层查询文档](event-views.md)为准；实机验收状态单独记录，不把离线检查当实机通过。

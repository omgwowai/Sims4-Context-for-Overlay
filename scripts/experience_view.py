...
from tool_support import report as emit_report, write_text


POLICY_VERSION = "experience_view_v1_1"
...
class Builder:
    def __init__(self, events, session_id, entity_key, game_version):
        ...
        filtered = filter_events(events, session_id)

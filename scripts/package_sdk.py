...
def main():
    ...
    files.append(ROOT / "docs/autonomy-capture.md")
    files.append(ROOT / "docs/autonomy-capture-plan.md")
    files.append(ROOT / "docs/validation/2026-09-16-autonomy-implementation.md")
    files.append(ROOT / "docs/validation/2026-09-16-autonomy-implementation.json")
    files.append(ROOT / "docs/validation/2026-09-16-autonomy-selection-probes.json")
    ...
    files.append(ROOT / "docs/validation/2026-09-16-semantic-supplements.md")
    files.append(ROOT / "docs/validation/2026-09-16-semantic-supplements.json")
    files.append(ROOT / "docs/validation/2026-09-16-semantic-supplements-first-live.md")
    files.append(ROOT / "docs/validation/2026-09-16-semantic-supplements-first-live.json")
    files.append(ROOT / "docs/validation/2026-09-16-semantic-parameter-fixes.md")
    files.append(ROOT / "docs/validation/2026-09-16-semantic-parameter-fixes.json")

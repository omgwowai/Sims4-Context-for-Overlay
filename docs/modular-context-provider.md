...
当前源码为 0.5.0，新增[公共 API v1 与 SDK](public-api-v1.md)作为三个模块的外部消费入口，仍以同一个脚本 MOD 提供数据；完成离线契约验证，尚未安装或实机验收。已安装的 0.3.2 具备状态／历史查看窗口，用户已确认布局，见[窗口使用说明](inspector-manual-test.md)。
